function initHMapTrials(continueTrial)
globalDefinitions;
...
if (continueTrial ==0) % start a new trial
    ...
    if totally_random == 0 %block by block
        if mod(NumOfSuccess,10)==0
            switch randomfig
                case 0
                    show_online(['Left&Up block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                case 1
                    show_online(['Left&Down block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                case 2
                    show_online(['Left&Left block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                case 3
                    show_online(['Right&Up block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                case 4
                    show_online(['Right&Down block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                case 5
                    show_online(['Right&Right block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
            end
        end
        if NumOfSuccess==30
        ...
        if mod(NumOfTrials,10) == 0
            show_online(['CorrectNum ErrorNum TotalNum CorrectRatio = ',num2str([NumOfSuccess NumOfError NumOfTrials NumOfSuccess/NumOfTrials]),'/',num2str(datestr(now,0))]);
        end
    end
    switch randomfig
        case 0
