function initTMapTrial(continueTrial)
...
if (continueTrial ==0) % start a new trial
    ...
    if totally_random == 0 %block by block
        if mod(NumOfSuccess,10)==0
                switch randomfig
                    case 0
                        show_online(['down&left block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                    case 1
                        show_online(['up&left, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                    case 2
                        show_online(['down&right, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                    case 3
                        show_online(['up&right, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
    ...
    switch randomfig
        case 0
            startTile = [20;11];
             pacMan.tile = struct('x',14,'y',5);
%               pacMan.tile = struct('x',6,'y',11);
            constructMap(28,36, [ ...
