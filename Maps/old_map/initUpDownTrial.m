function initUpDownTrial(continueTrial)
...
if (continueTrial ==0) % start a new trial
    ...
    if totally_random == 0 %block by block
        if mod(NumOfSuccess,10)==0
                switch randomfig
                    case 0
                        show_online(['up block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                    case 1
                        show_online(['down block, CR = ',num2str(NumOfSuccess/NumOfTrials),'//',num2str(datestr(now,0))]);
                end
                if NumOfSuccess==30
