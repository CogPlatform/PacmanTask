% Medium Map with a Moving Blinky
% edited by hy 20170321
function initStupidGhostTrial(continueTrial)

globalDefinitions;
global doesGhostMove;doesGhostMove = 1;
global randomfig;randomfig=0;
global NumOfTrials;
global NumOfError;
global NumOfSuccess;
global EndReward; EndReward=4;
...
if totally_random == 0 %block by block
    ...
    randomfig = round(4*rand);
    if mod(NumOfTrials,5)==0
        ...
        if NumOfSuccess/NumOfTrials > 0.5
            EndReward=4;    % setting num of end reward   --hy
        else
            EndReward=2;
        end
